...
variable "auth_image" {
  type    = string
  default = "904233121598.dkr.ecr.eu-north-1.amazonaws.com/auth-service:latest"
}

variable "user_image" {
  type    = string
  default = "904233121598.dkr.ecr.eu-north-1.amazonaws.com/user-service:latest"
}

variable "frontend_image" {
  type    = string
  default = "904233121598.dkr.ecr.eu-north-1.amazonaws.com/frontend:latest"
}
